...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/acpype-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/acpype-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `acpype` available on your platform:
...
```
mamba search acpype --channel conda-forge
```
...
```
pixi search acpype --channel conda-forge
```
...
mamba repoquery search acpype --channel conda-forge

# List packages depending on `acpype`:
mamba repoquery whoneeds acpype --channel conda-forge

# List dependencies of `acpype`:
mamba repoquery depends acpype --channel conda-forge
```
